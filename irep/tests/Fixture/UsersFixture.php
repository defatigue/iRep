...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'firstname' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'lastname' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'federal_constituency' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'federal_constituency' => ['type' => 'index', 'columns' => ['federal_constituency'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_no'], 'length' => []],
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['federal_constituency'], 'references' => ['federal_constituencies', 'id_no'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
