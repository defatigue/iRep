...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>The Project | Register</title>
            ...
            <div class="banner clearfix">
                ...
                <div class="container">
                    <div class="row"><div id=""></div>
                        ...
                        <?php
                            foreach($federalConstituency as $fc)
                            {
                                $FederalConstituencies[] = array('value'=>$fc->id_no, 'text'=>$fc->federal_constituency);
                            }
                        ?>
                            <?= $this->Form->create($user) ?>
                            <fieldset>
                                <legend><?= __('Please Supply The Information Below') ?></legend>
                                <?php
